...
'This opens the MESDBA Database on Fanta
    ...
    If Request("pr") <> "" Then
        ...
        sel = "SELECT S1.SERIAL_NBR AS ""Serial Number"", M1.PART_NBR, S1.QTY, S1.INSERT_TMSTM "
        frm = "FROM MESDBA.STANDARD_PACK S1, MESDBA.MES_PART M1 "
        whr = "WHERE M1.MES_PART_ID = S1.MES_PART_ID AND S1.PRODUCTION_RUN_ID =  '" & Request("pr") & "' "
        ord = ""
        sql = sel & frm & whr & ord & ";"   
