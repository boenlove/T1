                ...
                <td>
                    <%
                        ...
                        SQL = "Select P.PROCESS_CONTAINER_ID AS ""TOTE ID"", M.PART_NBR AS ""PART NUMBER"", " & _
                              "P.QTY AS ""QUANTITY"", P.INSERT_TMSTM AS ""TIME"", P.DISPOSITION_CODE AS ""LOCATION"", P.MOD_USERID AS ""OPERATOR"" From MESDBA.PROCESS_CONTAINER P, MESDBA.MES_PART M " & _
                              "WHERE (M.MES_PART_ID = P.MES_PART_ID) AND P.DISPOSITION_CODE = '"& Request.QueryString("disp") & "' ORDER BY P.PROCESS_CONTAINER_ID ASC;"
