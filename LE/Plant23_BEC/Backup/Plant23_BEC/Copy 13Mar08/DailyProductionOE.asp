...
<html>
    <head>
        <title>Daily Production OE</title>
            ...
            <tr>
                <td>
                    <%
                       ...
                       SQL = "SELECT P1.PRODUCTION_RUN_ID AS ""PRODUCTION RUN"", P1.PROCESS_CONTAINER_ID ""TOTE ID"", M1.MACHINE_NAME AS ""MACHINE"", PART.PART_NBR AS ""PART NUMBER"", P1.QTY AS ""TOTE QUANTITY"", P1.DISPOSITION_CODE, P1.INSERT_TMSTM AS ""START TIME"", " & _
                            ...
                            "(M1.MACHINE_NAME = '" & val5 & "') AND " & _
                           "(TO_CHAR(P1.INSERT_TMSTM, 'MM-DD-YYYY HH24:MI:SS') BETWEEN '" & val & " " & val3 & "' AND '"& val2 & " " & val4 & "') AND " & _
                           "(TO_CHAR(P1.MOD_TMSTM, 'MM-DD-YYYY HH24:MI:SS') BETWEEN '" & val & " " & val3 & "' AND '"& val2 & " " & val4 & "') AND " & _
                           "(P1.DISPOSITION_CODE IN ('ContainerPacked'))" & _
                            "ORDER BY P1.INSERT_TMSTM"
