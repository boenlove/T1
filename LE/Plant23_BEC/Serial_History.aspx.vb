...
#End Region
    ...
    Sub Populate_dgPRODUCT_ID()
        ...
        Try
            SearchDate = DateAdd(DateInterval.Day, -350, DateTime.Today())
            'Jerry change by Lance request 08042018
            'sel = "SELECT ('Lot_History.aspx?Product_Id=' || PRODUCT_ID || '') AS Lot_Content, SERIAL_NBR, PRODUCED_TMSTM"
            
            sel = "SELECT ('Lot_History.aspx?Product_Id=' || PRODUCT_ID || '') AS Lot_Content, Regexp_Replace(SERIAL_NBR,'_|:','') as SERIAL_NBR, PRODUCED_TMSTM"
